...
@click.option('--param_file', default='params/maskcon_4_4_4.json', help='JSON parameters file')
    ...
    for epoch in range(NUM_EPOCHS):
        ...
        with torch.no_grad():
            for batch_val in val_loader:
                val_images = Variable(batch_val[0].to(device))
                labels_val = {}
                ...
                for i, t in enumerate(all_tasks):
                    ...
                    labels_val[t] = Variable(labels_val[t].to(device))
        ...
        if epoch % 3 == 0 or (error_sum < error_sum_min and epoch >= 3):
            ...
            if epoch == 0:
                ...
                copy('multi_task/models/maskcon_multi_faces_resnet.py', saved_models_prefix)
